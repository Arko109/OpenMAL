...
namespace OpenMAL.API.Test
{
    ...
    public class MangaForListAllOfTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" MangaForListAllOf
            //Assert.IsInstanceOfType<MangaForListAllOf> (instance, "variable 'instance' is a MangaForListAllOf");
        }
