...
namespace OpenMAL.API.Test
{
    ...
    public class UserAllOfAnimeStatisticsTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsInstanceOfType" UserAllOfAnimeStatistics
            //Assert.IsInstanceOfType<UserAllOfAnimeStatistics> (instance, "variable 'instance' is a UserAllOfAnimeStatistics");
        }
