...
namespace OpenMAL.API.Api
{
    ...
    public interface IMangaApiAsync : IApiAccessor
    {
        ...
        /// Get manga ranking
        /// </summary>
        /// <remarks>The returned manga contains the `ranking` field.</remarks>
        /// <exception cref="OpenMAL.API.Client.ApiException">
        /// Thrown when fails to make API call
        /// </exception>
    ...
    public partial class MangaApi : IMangaApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaApi"/> class using Configuration object
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaApi"/> class using a Configuration
