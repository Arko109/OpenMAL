...
namespace OpenMAL.API.Api
{
    ...
    public interface IUserMangalistApiAsync : IApiAccessor
    {
        ...
        /// </summary>
        /// <remarks>
        /// Add specified manga to my manga list. If specified manga already exists, update its
        ...
        /// <param name="status">
        /// Filters returned manga list by these statuses. To return all manga, don't specify this
        /// field. Valid values: - reading - completed - on_hold - dropped - plan_to_read (optional)
        /// </param>
        /// <param name="sort">
        /// Valid values: | Value | Order | | - -- - | - -- - | | `list_score` | Descending | |
        /// `list_updated_at` | Descending | | `manga_title` | Ascending | | `manga_start_date` |
        /// Descending | | `manga_id` (Under Development) | Ascending | (optional)
        /// </param>
    ...
    public partial class UserMangalistApi : IUserMangalistApi
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserMangalistApi"/> class using
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UserMangalistApi"/> class using a
        ...
        /// <summary>
        /// Delete my manga list item. If the specified manga does not exist in user's manga list,
        ...
        /// <summary>
        /// Update my manga list status Add specified manga to my manga list. If specified manga
