...
namespace OpenMAL.API.Client
{
    ...
    {
        /// <summary>
        /// Provides a case-insensitive check that a provided content type is a known JSON-like
        /// content type.
        /// </summary>
        ...
        /// <summary>
        /// If parameter is DateTime, output in a formatted string (default ISO 8601), customizable
        /// with Configuration.DateTime. If parameter is a list, join the list with ",". Otherwise
        ...
        public static string ParameterToString(object obj, IReadableConfiguration configuration = null)
        {
            if (obj is DateTime dateTime)
                // Return a formatted date string - Can be customized with
                // Configuration.DateTimeFormat Defaults to an ISO 8601, using the known as a
                // Round-trip date/time pattern ("o")
                // https://msdn.microsoft.com/en-us/library/az4se3k1(v=vs.110).aspx#Anchor_8 For
                // example: 2009-06-15T13:45:30.0000000
        ...
        /// <summary>
        /// Select the Accept header's value from the given accepts array: if JSON exists in the
        /// given array, use it; otherwise use all of them (joining into a string)
        /// </summary>
        ...
        /// <summary>
        /// Select the Content-Type header's value from the given content-type array: if JSON type
        /// exists in the given array, use it; otherwise use the first one defined in 'consumes'
        /// </summary>
