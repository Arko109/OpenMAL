...
{
    /// <summary>
    /// Provides a default implementation of an Api client (both synchronous and asynchronous
    /// implementatios), encapsulating general REST accessor use cases.
    /// </summary>
    public partial class ApiClient : ISynchronousClient, IAsynchronousClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient"/>, defaulting to the global
        /// configurations' base url.
        /// </summary>
        public ApiClient()
        {
            _baseUrl = OpenMAL.API.Client.GlobalConfiguration.Instance.BasePath;
        }
        ...
        /// <summary>
        /// Provides all logic for constructing a new RestSharp <see cref="RestRequest"/>. At this
        /// point, all information for querying the service is known. Here, it is simply mapped into
        /// the RestSharp request.
        /// </summary>
            ...
            IReadableConfiguration configuration)
        {
            ...
            if (options.Data != null)
            {
                ...
                {
                    // Here, we'll assume JSON APIs are more common. XML can be forced by adding
                    // produces/consumes to openapi spec explicitly.
                    request.RequestFormat = DataFormat.Json;
                }
    ...
    /// <summary>
    /// Allows RestSharp to Serialize/Deserialize JSON using our custom logic, but only when
    /// ContentType is JSON.
    /// </summary>
