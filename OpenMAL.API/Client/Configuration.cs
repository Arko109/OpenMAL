...
namespace OpenMAL.API.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the API key based on the authentication name. This is the key and value
        /// comprising the "secret" for acessing an API.
        /// </summary>
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api.myanimelist.net/v2";
        ...
        public Configuration(
            ...
            string basePath = "https://api.myanimelist.net/v2") : this()
        {
        ...
        ///
        /// An example invocation here might be: <example> ApiKeyPrefix["Authorization"] = "Bearer";
        /// </example> … where ApiKey["Authorization"] would then be used to set the value of your
        /// bearer token.
        ///
        /// <remarks> OAuth2 workflows should set tokens via AccessToken. </remarks>
        /// </summary>
        /// <value>The prefix of the API key.</value>
        ...
        /// <summary>
        /// Gets or sets the date time format used when serializing in the ApiClient By default,
        /// it's set to ISO 8601 - "o", for others see:
        /// https://msdn.microsoft.com/en-us/library/az4se3k1(v=vs.110).aspx and
        /// https://msdn.microsoft.com/en-us/library/8kb3ddd4(v=vs.110).aspx No validation is done
        /// to ensure that the string you're providing is valid
        /// </summary>
        ...
        public virtual string DateTimeFormat
        {
            ...
            set
            {
                ...
                // Caution, no validation when you choose date time format other than ISO 8601 Take
                // a look at the above links
        ...
        {
            String report = "C# SDK (OpenMAL.API) Debug Report:\n";
