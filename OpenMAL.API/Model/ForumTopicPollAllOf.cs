...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicPollAllOf : IEquatable<ForumTopicPollAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicPollAllOf"/> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="question">question.</param>
        /// <param name="close">close.</param>
        /// <param name="options">options.</param>
        public ForumTopicPollAllOf(int id = default(int), string question = default(string), bool close = default(bool), List<ForumTopicPollOption> options = default(List<ForumTopicPollOption>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ForumTopicPollAllOf);
        }

        /// <summary>
        /// Returns true if ForumTopicPollAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicPollAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicPollAllOf input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicPollAllOf {\n");
