...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserAnimeListEdge : IEquatable<UserAnimeListEdge>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserAnimeListEdge"/> class.
        /// </summary>
        /// <param name="node">node.</param>
        /// <param name="listStatus">listStatus.</param>
        public UserAnimeListEdge(AnimeForList node = default(AnimeForList), AnimeListStatus listStatus = default(AnimeListStatus))
        {
            this.Node = node;
        ...
        /// <summary>
        /// Gets or Sets ListStatus
        /// </summary>
        [DataMember(Name = "list_status", EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as UserAnimeListEdge);
        }

        /// <summary>
        /// Returns true if UserAnimeListEdge instances are equal
        /// </summary>
        /// <param name="input">Instance of UserAnimeListEdge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserAnimeListEdge input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    this.ListStatus == input.ListStatus ||
                    (this.ListStatus != null &&
                    this.ListStatus.Equals(input.ListStatus))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ListStatus != null)
                    hashCode = hashCode * 59 + this.ListStatus.GetHashCode();
                return hashCode;
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserAnimeListEdge {\n");
            sb.Append("  Node: ").Append(Node).Append("\n");
            sb.Append("  ListStatus: ").Append(ListStatus).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    }
