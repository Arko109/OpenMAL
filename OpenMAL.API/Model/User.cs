...
namespace OpenMAL.API.Model
{
    ...
    public partial class User : IEquatable<User>
    {
        ...
        public User(int id = default(int), string name = default(string), string picture = default(string), string gender = default(string), DateTime? birthday = default(DateTime?), string location = default(string), DateTime joinedAt = default(DateTime), UserAllOfAnimeStatistics animeStatistics = default(UserAllOfAnimeStatistics), string timeZone = default(string), bool? isSupporter = default(bool?))
        {
            this.Id = id;
            this.Name = name;
