...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeListForRanking : IEquatable<AnimeListForRanking>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeListForRanking"/> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public AnimeListForRanking(List<AnimeListForRankingAllOfData> data = default(List<AnimeListForRankingAllOfData>), ListPaging paging = default(ListPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
        ...
        {
            return this.Equals(input as AnimeListForRanking);
        }

        /// <summary>
        /// Returns true if AnimeListForRanking instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeListForRanking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeListForRanking input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimeListForRanking {\n");
