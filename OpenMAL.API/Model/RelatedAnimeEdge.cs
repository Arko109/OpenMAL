...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RelatedAnimeEdge : IEquatable<RelatedAnimeEdge>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RelatedAnimeEdge"/> class.
        /// </summary>
        ...
        /// </param>
        public RelatedAnimeEdge(AnimeForList node = default(AnimeForList), string relationType = default(string), string relationTypeFormatted = default(string))
        {
            this.Node = node;
        ...
        /// <summary>
        /// The type of the relationship between this work and related work. - sequel - prequel -
        /// alternative_setting - alternative_version - side_story - parent_story - summary - full_story
        /// </summary>
        /// <value>
        /// The type of the relationship between this work and related work. - sequel - prequel -
        /// alternative_setting - alternative_version - side_story - parent_story - summary - full_story
        ...
        {
            return this.Equals(input as RelatedAnimeEdge);
        }

        /// <summary>
        /// Returns true if RelatedAnimeEdge instances are equal
        /// </summary>
        /// <param name="input">Instance of RelatedAnimeEdge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RelatedAnimeEdge input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RelatedAnimeEdge {\n");
