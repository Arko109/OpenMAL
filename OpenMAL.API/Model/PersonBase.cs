...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonBase :  IEquatable<PersonBase>
    {
        /// <summary>
        ...
        public PersonBase(int id = default(int), string firstName = default(string), string lastName = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as PersonBase);
        }

        /// <summary>
        /// Returns true if PersonBase instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonBase input)
        {
            if (input == null)
                return false;
