...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeList :  IEquatable<AnimeList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeList" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public AnimeList(List<AnimeListAllOfData> data = default(List<AnimeListAllOfData>), ListPaging paging = default(ListPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
        ...
        {
            return this.Equals(input as AnimeList);
        }

        /// <summary>
        /// Returns true if AnimeList instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeList input)
        {
            if (input == null)
                return false;
