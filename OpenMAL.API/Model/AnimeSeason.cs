...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeSeason : IEquatable<AnimeSeason>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeSeason"/> class.
        /// </summary>
        /// <param name="year">year.</param>
        /// <param name="season">season.</param>
        public AnimeSeason(int year = default(int), SeasonEnum? season = default(SeasonEnum?))
        {
            this.Year = year;
            this.Season = season;
        }
        ...
        {
            /// <summary>
            /// Enum Winter for value: winter
            /// </summary>
            [EnumMember(Value = "winter")]
            Winter = 1,

            /// <summary>
            /// Enum Spring for value: spring
            /// </summary>
            [EnumMember(Value = "spring")]
            Spring = 2,

            /// <summary>
            /// Enum Summer for value: summer
            /// </summary>
            [EnumMember(Value = "summer")]
            Summer = 3,

            /// <summary>
            /// Enum Fall for value: fall
            /// </summary>
        ...
        {
            return this.Equals(input as AnimeSeason);
        }

        /// <summary>
        /// Returns true if AnimeSeason instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeSeason to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeSeason input)
        {
            if (input == null)
                return false;
