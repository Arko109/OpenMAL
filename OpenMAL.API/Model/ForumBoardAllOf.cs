...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumBoardAllOf :  IEquatable<ForumBoardAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumBoardAllOf" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        /// <param name="subboards">subboards.</param>
        public ForumBoardAllOf(int id = default(int), string title = default(string), string description = default(string), List<ForumSubboard> subboards = default(List<ForumSubboard>))
        {
            this.Id = id;
            this.Title = title;
        ...
        /// <summary>
        /// Gets or Sets Subboards
        /// </summary>
        [DataMember(Name="subboards", EmitDefaultValue=false)]
        public List<ForumSubboard> Subboards { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumBoardAllOf {\n");
        ...
        {
            return this.Equals(input as ForumBoardAllOf);
        }

        /// <summary>
        /// Returns true if ForumBoardAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumBoardAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumBoardAllOf input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Subboards == input.Subboards ||
                    this.Subboards != null &&
                    input.Subboards != null &&
                    this.Subboards.SequenceEqual(input.Subboards)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Subboards != null)
                    hashCode = hashCode * 59 + this.Subboards.GetHashCode();
                return hashCode;
            }
        }
