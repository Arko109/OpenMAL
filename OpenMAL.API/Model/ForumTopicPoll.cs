...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicPoll : ForumTopicPollAllOf,  IEquatable<ForumTopicPoll>
    {
        /// <summary>
        ...
        public ForumTopicPoll(int id = default(int), string question = default(string), bool close = default(bool), List<ForumTopicPollOption> options = default(List<ForumTopicPollOption>)) : base()
        {
        }
