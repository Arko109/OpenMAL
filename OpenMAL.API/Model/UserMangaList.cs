...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserMangaList :  IEquatable<UserMangaList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserMangaList" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public UserMangaList(List<UserMangaListEdge> data = default(List<UserMangaListEdge>), ListPaging paging = default(ListPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
        ...
        {
            return this.Equals(input as UserMangaList);
        }

        /// <summary>
        /// Returns true if UserMangaList instances are equal
        /// </summary>
        /// <param name="input">Instance of UserMangaList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserMangaList input)
        {
            if (input == null)
                return false;
