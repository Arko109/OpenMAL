...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicsAllOf :  IEquatable<ForumTopicsAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicsAllOf" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public ForumTopicsAllOf(List<ForumTopicsData> data = default(List<ForumTopicsData>), ForumTopicPaging paging = default(ForumTopicPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
        ...
        public List<ForumTopicsData> Data { get; set; }

        /// <summary>
        /// Gets or Sets Paging
        /// </summary>
        [DataMember(Name="paging", EmitDefaultValue=false)]
        public ForumTopicPaging Paging { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicsAllOf {\n");
        ...
        {
            return this.Equals(input as ForumTopicsAllOf);
        }

        /// <summary>
        /// Returns true if ForumTopicsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicsAllOf input)
        {
            if (input == null)
                return false;
