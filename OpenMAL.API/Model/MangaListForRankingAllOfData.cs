...
{
    /// <summary>
    /// MangaListForRankingAllOfData
    /// </summary>
    [DataContract]
    public partial class MangaListForRankingAllOfData :  IEquatable<MangaListForRankingAllOfData>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaListForRankingAllOfData {\n");
        ...
        {
            return this.Equals(input as MangaListForRankingAllOfData);
        }

        /// <summary>
        /// Returns true if MangaListForRankingAllOfData instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaListForRankingAllOfData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaListForRankingAllOfData input)
        {
            if (input == null)
                return false;
