...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumCategory : ForumCategoryAllOf, IEquatable<ForumCategory>
    {
        /// <summary>
        ...
        public ForumCategory(string title = default(string), List<ForumBoard> boards = default(List<ForumBoard>)) : base()
        {
        }
        ...
        {
            return this.Equals(input as ForumCategory);
        }

        /// <summary>
        /// Returns true if ForumCategory instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumCategory to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumCategory input)
        {
            if (input == null)
                return false;
