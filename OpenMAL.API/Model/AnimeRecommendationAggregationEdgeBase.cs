...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeRecommendationAggregationEdgeBase :  IEquatable<AnimeRecommendationAggregationEdgeBase>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeRecommendationAggregationEdgeBase" /> class.
        /// </summary>
        /// <param name="node">node.</param>
        /// <param name="numRecommendations">numRecommendations.</param>
        public AnimeRecommendationAggregationEdgeBase(AnimeForList node = default(AnimeForList), int numRecommendations = default(int))
        {
            this.Node = node;
        ...
        /// <summary>
        /// Gets or Sets NumRecommendations
        /// </summary>
        [DataMember(Name="num_recommendations", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimeRecommendationAggregationEdgeBase {\n");
            sb.Append("  Node: ").Append(Node).Append("\n");
            sb.Append("  NumRecommendations: ").Append(NumRecommendations).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as AnimeRecommendationAggregationEdgeBase);
        }

        /// <summary>
        /// Returns true if AnimeRecommendationAggregationEdgeBase instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeRecommendationAggregationEdgeBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeRecommendationAggregationEdgeBase input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NumRecommendations == input.NumRecommendations ||
                    this.NumRecommendations.Equals(input.NumRecommendations)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.NumRecommendations.GetHashCode();
                return hashCode;
            }
        }
