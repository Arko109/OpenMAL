...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MangaListAllOf :  IEquatable<MangaListAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaListAllOf" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MangaListAllOf(List<MangaListAllOfData> data = default(List<MangaListAllOfData>))
        {
            this.Data = data;
        }
        ...
        public List<MangaListAllOfData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaListAllOf {\n");
        ...
        {
            return this.Equals(input as MangaListAllOf);
        }

        /// <summary>
        /// Returns true if MangaListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaListAllOf input)
        {
            if (input == null)
                return false;
