...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkBase :  IEquatable<WorkBase>
    {
        /// <summary>
        ...
        public WorkBase(int id = default(int), string title = default(string), Object mainPicture = default(Object))
        {
            this.Id = id;
            this.Title = title;
        ...
        {
            return this.Equals(input as WorkBase);
        }

        /// <summary>
        /// Returns true if WorkBase instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkBase input)
        {
            if (input == null)
                return false;
