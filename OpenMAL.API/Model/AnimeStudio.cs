...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeStudio :  IEquatable<AnimeStudio>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeStudio" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public AnimeStudio(int id = default(int), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        {
            return this.Equals(input as AnimeStudio);
        }

        /// <summary>
        /// Returns true if AnimeStudio instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeStudio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeStudio input)
        {
            if (input == null)
                return false;
