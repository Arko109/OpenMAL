...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumBoardsAllOf :  IEquatable<ForumBoardsAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumBoardsAllOf" /> class.
        /// </summary>
        /// <param name="categories">categories.</param>
        public ForumBoardsAllOf(List<ForumCategory> categories = default(List<ForumCategory>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumBoardsAllOf {\n");
        ...
        {
            return this.Equals(input as ForumBoardsAllOf);
        }

        /// <summary>
        /// Returns true if ForumBoardsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumBoardsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumBoardsAllOf input)
        {
            if (input == null)
                return false;
