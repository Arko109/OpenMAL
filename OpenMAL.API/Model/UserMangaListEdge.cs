...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserMangaListEdge :  IEquatable<UserMangaListEdge>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserMangaListEdge {\n");
        ...
        {
            return this.Equals(input as UserMangaListEdge);
        }

        /// <summary>
        /// Returns true if UserMangaListEdge instances are equal
        /// </summary>
        /// <param name="input">Instance of UserMangaListEdge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserMangaListEdge input)
        {
            if (input == null)
                return false;
