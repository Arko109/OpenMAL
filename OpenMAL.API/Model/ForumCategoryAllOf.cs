...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumCategoryAllOf : IEquatable<ForumCategoryAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumCategoryAllOf"/> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="boards">boards.</param>
        public ForumCategoryAllOf(string title = default(string), List<ForumBoard> boards = default(List<ForumBoard>))
        {
            this.Title = title;
            this.Boards = boards;
        }
        ...
        {
            return this.Equals(input as ForumCategoryAllOf);
        }

        /// <summary>
        /// Returns true if ForumCategoryAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumCategoryAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumCategoryAllOf input)
        {
            if (input == null)
                return false;
            ...
            return
                ...
                (
                    ...
                    this.Boards != null &&
                    input.Boards != null &&
                    this.Boards.SequenceEqual(input.Boards)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Boards != null)
                    hashCode = hashCode * 59 + this.Boards.GetHashCode();
                return hashCode;
            }
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumCategoryAllOf {\n");
