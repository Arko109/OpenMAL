...
{
    /// <summary>
    /// ForumTopicsDataAllOf
    /// </summary>
    [DataContract]
    public partial class ForumTopicsDataAllOf : IEquatable<ForumTopicsDataAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicsDataAllOf"/> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ForumTopicsDataAllOf);
        }

        /// <summary>
        /// Returns true if ForumTopicsDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicsDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicsDataAllOf input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicsDataAllOf {\n");
