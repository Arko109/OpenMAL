...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicData : ForumTopicDataAllOf,  IEquatable<ForumTopicData>
    {
        /// <summary>
        ...
        public ForumTopicData(string title = default(string), List<ForumTopicPost> posts = default(List<ForumTopicPost>), List<ForumTopicPoll> poll = default(List<ForumTopicPoll>)) : base()
        {
        }
