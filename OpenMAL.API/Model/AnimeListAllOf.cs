...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeListAllOf : IEquatable<AnimeListAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeListAllOf"/> class.
        /// </summary>
        /// <param name="data">data.</param>
        public AnimeListAllOf(List<AnimeListAllOfData> data = default(List<AnimeListAllOfData>))
        {
            this.Data = data;
        }
        ...
        public List<AnimeListAllOfData> Data { get; set; }
        ...
        {
            return this.Equals(input as AnimeListAllOf);
        }

        /// <summary>
        /// Returns true if AnimeListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeListAllOf input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimeListAllOf {\n");
