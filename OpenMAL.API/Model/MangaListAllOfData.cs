...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MangaListAllOfData : IEquatable<MangaListAllOfData>
    {
        /// <summary>
        ...
        {
            return this.Equals(input as MangaListAllOfData);
        }

        /// <summary>
        /// Returns true if MangaListAllOfData instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaListAllOfData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaListAllOfData input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaListAllOfData {\n");
