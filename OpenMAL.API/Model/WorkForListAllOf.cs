...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class WorkForListAllOf :  IEquatable<WorkForListAllOf>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WorkForListAllOf {\n");
        ...
        {
            return this.Equals(input as WorkForListAllOf);
        }

        /// <summary>
        /// Returns true if WorkForListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of WorkForListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WorkForListAllOf input)
        {
            if (input == null)
                return false;
