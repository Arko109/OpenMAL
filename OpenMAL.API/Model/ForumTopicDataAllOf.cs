...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicDataAllOf : IEquatable<ForumTopicDataAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicDataAllOf"/> class.
        /// </summary>
        /// <param name="title">title.</param>
        /// <param name="posts">posts.</param>
        /// <param name="poll">poll.</param>
        public ForumTopicDataAllOf(string title = default(string), List<ForumTopicPost> posts = default(List<ForumTopicPost>), List<ForumTopicPoll> poll = default(List<ForumTopicPoll>))
        {
            this.Title = title;
            this.Posts = posts;
            this.Poll = poll;
        ...
        {
            return this.Equals(input as ForumTopicDataAllOf);
        }

        /// <summary>
        /// Returns true if ForumTopicDataAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicDataAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicDataAllOf input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicDataAllOf {\n");
