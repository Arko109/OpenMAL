...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopics : ForumTopicsAllOf, IEquatable<ForumTopics>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopics"/> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public ForumTopics(List<ForumTopicsData> data = default(List<ForumTopicsData>), ForumTopicPaging paging = default(ForumTopicPaging)) : base()
        {
        }
        ...
        {
            return this.Equals(input as ForumTopics);
        }

        /// <summary>
        /// Returns true if ForumTopics instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopics input)
        {
            if (input == null)
                return false;
