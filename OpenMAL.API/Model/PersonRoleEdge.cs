...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PersonRoleEdge : IEquatable<PersonRoleEdge>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PersonRoleEdge"/> class.
        /// </summary>
        /// <param name="node">node.</param>
        /// <param name="role">role.</param>
        public PersonRoleEdge(PersonBase node = default(PersonBase), string role = default(string))
        {
            this.Node = node;
            this.Role = role;
        }
        ...
        {
            return this.Equals(input as PersonRoleEdge);
        }

        /// <summary>
        /// Returns true if PersonRoleEdge instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonRoleEdge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonRoleEdge input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonRoleEdge {\n");
