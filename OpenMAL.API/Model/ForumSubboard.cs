...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumSubboard :  IEquatable<ForumSubboard>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumSubboard" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="title">title.</param>
        public ForumSubboard(int id = default(int), string title = default(string))
        {
            this.Id = id;
            this.Title = title;
        }
        ...
        {
            return this.Equals(input as ForumSubboard);
        }

        /// <summary>
        /// Returns true if ForumSubboard instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumSubboard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumSubboard input)
        {
            if (input == null)
                return false;
