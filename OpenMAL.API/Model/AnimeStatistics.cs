...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeStatistics :  IEquatable<AnimeStatistics>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeStatistics" /> class.
        /// </summary>
        /// <param name="numListUsers">numListUsers.</param>
        /// <param name="status">status.</param>
        public AnimeStatistics(int numListUsers = default(int), AnimeStatisticsStatus status = default(AnimeStatisticsStatus))
        {
        ...
        public AnimeStatisticsStatus Status { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimeStatistics {\n");
        ...
        {
            return this.Equals(input as AnimeStatistics);
        }

        /// <summary>
        /// Returns true if AnimeStatistics instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeStatistics to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeStatistics input)
        {
            if (input == null)
                return false;
