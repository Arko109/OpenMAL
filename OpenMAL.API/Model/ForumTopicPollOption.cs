...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicPollOption :  IEquatable<ForumTopicPollOption>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicPollOption" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="text">text.</param>
        /// <param name="votes">votes.</param>
        public ForumTopicPollOption(int id = default(int), string text = default(string), int votes = default(int))
        {
            this.Id = id;
            this.Text = text;
            this.Votes = votes;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicPollOption {\n");
        ...
        {
            return this.Equals(input as ForumTopicPollOption);
        }

        /// <summary>
        /// Returns true if ForumTopicPollOption instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicPollOption to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicPollOption input)
        {
            if (input == null)
                return false;
