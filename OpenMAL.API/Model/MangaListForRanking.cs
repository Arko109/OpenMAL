...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MangaListForRanking : IEquatable<MangaListForRanking>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaListForRanking"/> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public MangaListForRanking(List<MangaListForRankingAllOfData> data = default(List<MangaListForRankingAllOfData>), ListPaging paging = default(ListPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
        ...
        {
            return this.Equals(input as MangaListForRanking);
        }

        /// <summary>
        /// Returns true if MangaListForRanking instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaListForRanking to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaListForRanking input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaListForRanking {\n");
