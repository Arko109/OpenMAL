...
{
    /// <summary>
    /// AnimeListForRankingAllOf
    /// </summary>
    [DataContract]
    public partial class AnimeListForRankingAllOf : IEquatable<AnimeListForRankingAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeListForRankingAllOf"/> class.
        /// </summary>
        /// <param name="data">data.</param>
        public AnimeListForRankingAllOf(List<AnimeListForRankingAllOfData> data = default(List<AnimeListForRankingAllOfData>))
        {
            this.Data = data;
        }
        ...
        public List<AnimeListForRankingAllOfData> Data { get; set; }
        ...
        {
            return this.Equals(input as AnimeListForRankingAllOf);
        }

        /// <summary>
        /// Returns true if AnimeListForRankingAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeListForRankingAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeListForRankingAllOf input)
        {
            if (input == null)
                return false;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AnimeListForRankingAllOf {\n");
