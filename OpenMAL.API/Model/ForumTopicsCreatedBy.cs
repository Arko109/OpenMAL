...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicsCreatedBy :  IEquatable<ForumTopicsCreatedBy>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicsCreatedBy" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="name">name.</param>
        public ForumTopicsCreatedBy(int id = default(int), string name = default(string))
        {
            this.Id = id;
            this.Name = name;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicsCreatedBy {\n");
        ...
        {
            return this.Equals(input as ForumTopicsCreatedBy);
        }

        /// <summary>
        /// Returns true if ForumTopicsCreatedBy instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicsCreatedBy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicsCreatedBy input)
        {
            if (input == null)
                return false;
