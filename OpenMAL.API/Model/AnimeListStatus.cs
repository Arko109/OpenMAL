...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeListStatus : IEquatable<AnimeListStatus>
    {
        /// <summary>
        ...
        /// <param name="numWatchedEpisodes">0 or the number of watched episodes. .</param>
        /// <param name="isRewatching">
        /// If authorized user watches an anime again after completion, this field value is true. In
        /// this case, MyAnimeList treats the anime as 'watching' in the user's anime list. .
        /// </param>
        ...
        public AnimeListStatus(string status = default(string), int score = default(int), int numWatchedEpisodes = default(int), bool isRewatching = default(bool), DateTime? startDate = default(DateTime?), DateTime? finishDate = default(DateTime?), int priority = default(int), int numTimesRewatched = default(int), int rewatchValue = default(int), List<string> tags = default(List<string>), string comments = default(string), DateTime updatedAt = default(DateTime))
        {
            this.Status = status;
            this.Score = score;
