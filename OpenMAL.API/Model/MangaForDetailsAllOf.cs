...
{
    /// <summary>
    /// MangaForDetailsAllOf
    /// </summary>
    [DataContract]
    public partial class MangaForDetailsAllOf :  IEquatable<MangaForDetailsAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaForDetailsAllOf" /> class.
        /// </summary>
        ...
        /// <param name="recommendations">Summary of recommended anime for those who like this manga.  You cannot contain this field in a list.  .</param>
        /// <param name="serialization">You cannot contain this field in a list. .</param>
        public MangaForDetailsAllOf(List<Picture> pictures = default(List<Picture>), string background = default(string), List<RelatedAnimeEdge> relatedAnime = default(List<RelatedAnimeEdge>), List<RelatedMangaEdge> relatedManga = default(List<RelatedMangaEdge>), List<MangaRecommendationAggregationEdgeBase> recommendations = default(List<MangaRecommendationAggregationEdgeBase>), List<MangaMagazineRelationEdge> serialization = default(List<MangaMagazineRelationEdge>))
        {
        ...
        /// <summary>
        /// Summary of recommended anime for those who like this manga.  You cannot contain this field in a list.  
        /// </summary>
        /// <value>Summary of recommended anime for those who like this manga.  You cannot contain this field in a list.  </value>
        [DataMember(Name="recommendations", EmitDefaultValue=false)]
        public List<MangaRecommendationAggregationEdgeBase> Recommendations { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaForDetailsAllOf {\n");
        ...
        {
            return this.Equals(input as MangaForDetailsAllOf);
        }

        /// <summary>
        /// Returns true if MangaForDetailsAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaForDetailsAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaForDetailsAllOf input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    input.Serialization != null &&
                    this.Serialization.SequenceEqual(input.Serialization)
                );
        }
