...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumBoard : ForumBoardAllOf, IEquatable<ForumBoard>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumBoard"/> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="title">title.</param>
        /// <param name="description">description.</param>
        /// <param name="subboards">subboards.</param>
        public ForumBoard(int id = default(int), string title = default(string), string description = default(string), List<ForumSubboard> subboards = default(List<ForumSubboard>)) : base()
        {
        }
        ...
        {
            return this.Equals(input as ForumBoard);
        }

        /// <summary>
        /// Returns true if ForumBoard instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumBoard to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumBoard input)
        {
            if (input == null)
                return false;
