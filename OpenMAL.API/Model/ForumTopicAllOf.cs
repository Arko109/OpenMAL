...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicAllOf :  IEquatable<ForumTopicAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumTopicAllOf" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        /// <param name="paging">paging.</param>
        public ForumTopicAllOf(List<ForumTopicData> data = default(List<ForumTopicData>), ForumTopicPaging paging = default(ForumTopicPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
        ...
        public List<ForumTopicData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ForumTopicAllOf {\n");
        ...
        {
            return this.Equals(input as ForumTopicAllOf);
        }

        /// <summary>
        /// Returns true if ForumTopicAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopicAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopicAllOf input)
        {
            if (input == null)
                return false;
