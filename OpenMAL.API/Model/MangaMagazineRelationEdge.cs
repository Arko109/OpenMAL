...
{
    /// <summary>
    /// MangaMagazineRelationEdge
    /// </summary>
    [DataContract]
    public partial class MangaMagazineRelationEdge :  IEquatable<MangaMagazineRelationEdge>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaMagazineRelationEdge" /> class.
        /// </summary>
        /// <param name="node">node.</param>
        /// <param name="role">role.</param>
        public MangaMagazineRelationEdge(Magazine node = default(Magazine), string role = default(string))
        {
            this.Node = node;
            this.Role = role;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaMagazineRelationEdge {\n");
        ...
        {
            return this.Equals(input as MangaMagazineRelationEdge);
        }

        /// <summary>
        /// Returns true if MangaMagazineRelationEdge instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaMagazineRelationEdge to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaMagazineRelationEdge input)
        {
            if (input == null)
                return false;
