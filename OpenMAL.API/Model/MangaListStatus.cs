...
namespace OpenMAL.API.Model
{
    ...
    public partial class MangaListStatus : IEquatable<MangaListStatus>
    {
        ...
        /// <param name="isRereading">
        /// If authorized user reads an manga again after completion, this field value is true. In
        /// this case, MyAnimeList treats the manga as 'reading' in the user's manga list. .
        /// </param>
