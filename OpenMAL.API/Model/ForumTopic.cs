...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopic : ForumTopicAllOf,  IEquatable<ForumTopic>
    {
        /// <summary>
        ...
        public ForumTopic(List<ForumTopicData> data = default(List<ForumTopicData>), ForumTopicPaging paging = default(ForumTopicPaging)) : base()
        {
        }
        ...
        {
            return this.Equals(input as ForumTopic);
        }

        /// <summary>
        /// Returns true if ForumTopic instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumTopic to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumTopic input)
        {
            if (input == null)
                return false;
