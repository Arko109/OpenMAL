...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserMangaListAllOf :  IEquatable<UserMangaListAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserMangaListAllOf" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public UserMangaListAllOf(List<UserMangaListEdge> data = default(List<UserMangaListEdge>))
        {
            this.Data = data;
        }
        ...
        public List<UserMangaListEdge> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserMangaListAllOf {\n");
        ...
        {
            return this.Equals(input as UserMangaListAllOf);
        }

        /// <summary>
        /// Returns true if UserMangaListAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of UserMangaListAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserMangaListAllOf input)
        {
            if (input == null)
                return false;
