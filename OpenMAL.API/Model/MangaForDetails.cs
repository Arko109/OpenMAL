...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MangaForDetails :  IEquatable<MangaForDetails>
    {
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaForDetails {\n");
        ...
        {
            return this.Equals(input as MangaForDetails);
        }

        /// <summary>
        /// Returns true if MangaForDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaForDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaForDetails input)
        {
            if (input == null)
                return false;
