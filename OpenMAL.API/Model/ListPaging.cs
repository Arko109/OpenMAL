...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListPaging :  IEquatable<ListPaging>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListPaging" /> class.
        /// </summary>
        /// <param name="previous">previous.</param>
        /// <param name="next">next.</param>
        public ListPaging(string previous = default(string), string next = default(string))
        {
        ...
        {
            return this.Equals(input as ListPaging);
        }

        /// <summary>
        /// Returns true if ListPaging instances are equal
        /// </summary>
        /// <param name="input">Instance of ListPaging to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListPaging input)
        {
            if (input == null)
                return false;
