...
{
    /// <summary>
    /// MangaListForRankingAllOf
    /// </summary>
    [DataContract]
    public partial class MangaListForRankingAllOf :  IEquatable<MangaListForRankingAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MangaListForRankingAllOf" /> class.
        /// </summary>
        /// <param name="data">data.</param>
        public MangaListForRankingAllOf(List<MangaListForRankingAllOfData> data = default(List<MangaListForRankingAllOfData>))
        {
            this.Data = data;
        }
        ...
        public List<MangaListForRankingAllOfData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MangaListForRankingAllOf {\n");
        ...
        {
            return this.Equals(input as MangaListForRankingAllOf);
        }

        /// <summary>
        /// Returns true if MangaListForRankingAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of MangaListForRankingAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MangaListForRankingAllOf input)
        {
            if (input == null)
                return false;
