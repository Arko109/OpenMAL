...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumBoards : ForumBoardsAllOf,  IEquatable<ForumBoards>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ForumBoards" /> class.
        /// </summary>
        /// <param name="categories">categories.</param>
        public ForumBoards(List<ForumCategory> categories = default(List<ForumCategory>)) : base()
        {
        }
        ...
        {
            return this.Equals(input as ForumBoards);
        }

        /// <summary>
        /// Returns true if ForumBoards instances are equal
        /// </summary>
        /// <param name="input">Instance of ForumBoards to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ForumBoards input)
        {
            if (input == null)
                return false;
