...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AnimeForList : IEquatable<AnimeForList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnimeForList"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Original work. - other - original - manga - 4_koma_manga - web_manga - digital_manga -
        /// novel - light_novel - visual_novel - game - card_game - book - picture_book - radio - music
        /// </summary>
        /// <value>
        /// Original work. - other - original - manga - 4_koma_manga - web_manga - digital_manga -
        /// novel - light_novel - visual_novel - game - card_game - book - picture_book - radio - music
        ...
        {
            return this.Equals(input as AnimeForList);
        }

        /// <summary>
        /// Returns true if AnimeForList instances are equal
        /// </summary>
        /// <param name="input">Instance of AnimeForList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AnimeForList input)
        {
            if (input == null)
                return false;
