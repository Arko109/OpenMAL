...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class MangaList :  IEquatable<MangaList>
    {
        /// <summary>
        ...
        public MangaList(List<MangaListAllOfData> data = default(List<MangaListAllOfData>), ListPaging paging = default(ListPaging))
        {
            this.Data = data;
            this.Paging = paging;
        }
