...
namespace OpenMAL.API.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ForumTopicsData : ForumTopicsDataAllOf,  IEquatable<ForumTopicsData>
    {
        /// <summary>
        ...
        public ForumTopicsData(int id = default(int), string title = default(string), DateTime createdAt = default(DateTime), ForumTopicsCreatedBy createdBy = default(ForumTopicsCreatedBy), int numberOfPosts = default(int), DateTime lastPostCreatedAt = default(DateTime), ForumTopicsCreatedBy lastPostCreatedBy = default(ForumTopicsCreatedBy), bool isLocked = default(bool)) : base()
        {
        }
